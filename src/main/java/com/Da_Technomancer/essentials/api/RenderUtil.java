...
public class RenderUtil{
	 ...
	 * Normally when doing this, simply rotate to the camera angle. However, if the 2d texture must be centered on a certain line (like an arrow), the formula is more complex
	 ...
	 * @param ray The direction of the fixed line, relative to start point
